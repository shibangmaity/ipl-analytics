...
/* ══════════════════════════════════════════════
   IPL NIGHT STADIUM — FULL CREATIVE BACKGROUND
   ══════════════════════════════════════════════ */

/* 1. Base: very dark navy — the night sky */
.stApp {
    background-color: #02040a !important;
    background-image:
        /* ── FLOODLIGHT SHAFTS (4 towers) ── */
        /* Top-left tower — wide warm cone sweeping down-right */
        conic-gradient(from 118deg at 0% 0%,
            transparent 0deg,
            rgba(255,200,80,0.13) 4deg,
            rgba(255,200,80,0.06) 12deg,
            transparent 18deg),
        /* Top-right tower */
        conic-gradient(from 242deg at 100% 0%,
            transparent 0deg,
            rgba(255,200,80,0.13) 4deg,
            rgba(255,200,80,0.06) 12deg,
            transparent 18deg),
        /* ── FLOODLIGHT POINT SOURCES (hard bright dots at corners) ── */
        radial-gradient(circle 90px at 2%  2%,  rgba(255,230,140,0.55) 0%, rgba(255,200,80,0.15) 30%, transparent 65%),
        radial-gradient(circle 90px at 98% 2%,  rgba(255,230,140,0.55) 0%, rgba(255,200,80,0.15) 30%, transparent 65%),
        radial-gradient(circle 60px at 2%  98%, rgba(255,210,100,0.30) 0%, transparent 55%),
        radial-gradient(circle 60px at 98% 98%, rgba(255,210,100,0.30) 0%, transparent 55%),
        /* ── LIGHT WASH across whole pitch area ── */
        radial-gradient(ellipse 80% 50% at 50% 35%, rgba(255,200,100,0.07) 0%, transparent 70%),
        /* ── OUTFIELD GREEN GLOW ── */
        radial-gradient(ellipse 100% 28% at 50% 102%, rgba(10,140,50,0.32) 0%, rgba(10,100,40,0.10) 55%, transparent 75%),
        /* ── PITCH STRIP warm clay glow ── */
        radial-gradient(ellipse 18% 45% at 50% 52%, rgba(210,160,70,0.20) 0%, rgba(180,120,40,0.06) 60%, transparent 80%),
        /* ── CRICKET BALL RED AURA (mid-left and mid-right) ── */
        radial-gradient(circle 220px at 8%  52%, rgba(200,30,20,0.14) 0%, transparent 65%),
        radial-gradient(circle 220px at 92% 52%, rgba(200,30,20,0.14) 0%, transparent 65%),
        /* ── NIGHT SKY gradient base ── */
        linear-gradient(175deg, #02040a 0%, #04091a 30%, #050d1f 60%, #030810 100%) !important;
    min-height: 100vh;
    position: relative;
}

/* 2. Stadium geometry layer — pitch, boundary, stands silhouette */
.stApp::before {
    content: '';
    position: fixed;
    inset: 0;
    ...
    z-index: 0;
    background-image:
        /* ── BOUNDARY ROPE (ellipse outline via layered radials) ── */
        radial-gradient(ellipse 78% 44% at 50% 68%,
            transparent 97%,
            rgba(255,255,255,0.06) 97.5%,
            rgba(255,255,255,0.06) 98.5%,
            transparent 99%),
        /* ── INNER CIRCLE (30-yard circle outline) ── */
        radial-gradient(ellipse 36% 20% at 50% 62%,
            transparent 95%,
            rgba(255,255,255,0.04) 95.5%,
            rgba(255,255,255,0.04) 97%,
            transparent 97.5%),
        /* ── PITCH CREASE LINES — batting & bowling ── */
        linear-gradient(180deg,
            transparent 48.8%,
            rgba(240,210,140,0.10) 49%,   rgba(240,210,140,0.10) 49.3%,
            transparent 49.3%,
            transparent 54.5%,
            rgba(240,210,140,0.10) 54.7%,  rgba(240,210,140,0.10) 55%,
            transparent 55%),
        /* ── FLOODLIGHT BEAM SHAFTS (diagonal streaks) ── */
        linear-gradient(148deg,
            transparent 0%,
            rgba(255,215,80,0.03) 18%, rgba(255,215,80,0.06) 19%,
            rgba(255,215,80,0.03) 20%, transparent 23%),
        linear-gradient(32deg,
            transparent 0%,
            rgba(255,215,80,0.03) 18%, rgba(255,215,80,0.06) 19%,
            rgba(255,215,80,0.03) 20%, transparent 23%),
        /* ── CROWD STAND SILHOUETTE at top ── */
        linear-gradient(180deg,
            rgba(0,0,0,0.65) 0%,
            rgba(0,0,0,0.30) 7%,
            transparent 14%),
        /* ── GROUND LEVEL VIGNETTE at bottom ── */
        ...
        linear-gradient(90deg,
            rgba(0,0,0,0.35) 0%, transparent 12%,
            transparent 88%, rgba(0,0,0,0.35) 100%);
}

/* 3. Animated star-dust particles (CSS only, pure twinkling dots) */
.stApp::after {
    content: '';
    position: fixed;
    inset: 0;
    ...
    z-index: 0;
    background-image:
        radial-gradient(circle 1px at 10% 8%,  rgba(255,255,255,0.55) 0%, transparent 100%),
        radial-gradient(circle 1px at 25% 5%,  rgba(255,255,255,0.40) 0%, transparent 100%),
        radial-gradient(circle 1px at 40% 10%, rgba(255,255,255,0.45) 0%, transparent 100%),
        radial-gradient(circle 1px at 60% 6%,  rgba(255,255,255,0.50) 0%, transparent 100%),
        radial-gradient(circle 1px at 75% 9%,  rgba(255,255,255,0.35) 0%, transparent 100%),
        radial-gradient(circle 1px at 88% 4%,  rgba(255,255,255,0.55) 0%, transparent 100%),
        radial-gradient(circle 1px at 15% 15%, rgba(255,255,255,0.30) 0%, transparent 100%),
        radial-gradient(circle 1px at 50% 13%, rgba(255,255,255,0.40) 0%, transparent 100%),
        radial-gradient(circle 1px at 82% 17%, rgba(255,255,255,0.35) 0%, transparent 100%),
        radial-gradient(circle 2px at 5%  12%, rgba(255,230,150,0.60) 0%, transparent 100%),
        radial-gradient(circle 2px at 93% 7%,  rgba(255,230,150,0.60) 0%, transparent 100%),
        radial-gradient(circle 1px at 33% 20%, rgba(255,255,255,0.25) 0%, transparent 100%),
        radial-gradient(circle 1px at 67% 18%, rgba(255,255,255,0.30) 0%, transparent 100%);
...
<div style="background:#07111e;border-bottom:0.5px solid #1a2a40;padding:8px 16px;margin-bottom:1rem;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
    <span style="font-size:10px;color:#304050;font-weight:700;margin-right:4px;letter-spacing:1px">NAVIGATE:</span>
""", unsafe_allow_html=True)
