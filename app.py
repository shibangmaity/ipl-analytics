...
/* ── IPL STADIUM NIGHT BACKGROUND ── */
.stApp {
    background-color: #03070f !important;
    background-image:
        /* 4 corner stadium floodlight hard cones */
        radial-gradient(ellipse 45% 55% at 0% 0%,   rgba(255,165,40,0.22) 0%, transparent 55%),
        radial-gradient(ellipse 45% 55% at 100% 0%, rgba(255,165,40,0.22) 0%, transparent 55%),
        radial-gradient(ellipse 35% 40% at 0% 100%,  rgba(255,140,20,0.10) 0%, transparent 50%),
        radial-gradient(ellipse 35% 40% at 100% 100%,rgba(255,140,20,0.10) 0%, transparent 50%),
        /* Central pitch warm glow */
        radial-gradient(ellipse 30% 18% at 50% 58%, rgba(200,140,60,0.18) 0%, transparent 70%),
        /* Outfield green halo rising from bottom */
        radial-gradient(ellipse 90% 35% at 50% 100%, rgba(20,160,60,0.18) 0%, transparent 65%),
        /* Cricket ball red hot-spot — left */
        radial-gradient(circle 180px at 15% 55%, rgba(180,30,20,0.12) 0%, transparent 70%),
        /* Cricket ball red hot-spot — right */
        radial-gradient(circle 180px at 85% 55%, rgba(180,30,20,0.12) 0%, transparent 70%),
        /* Deep navy-black base */
        linear-gradient(170deg, #03070f 0%, #050c1a 45%, #030810 100%) !important;
    min-height: 100vh;
}

/* Stadium SVG-style pitch markings + seam overlay */
.stApp::before {
    content: '';
    position: fixed;
    inset: 0;
    background-image:
        /* pitch crease lines — two faint horizontal bars */
        linear-gradient(180deg,
            transparent 43%,
            rgba(220,190,120,0.06) 43.3%, rgba(220,190,120,0.06) 43.7%,
            transparent 43.7%,
            transparent 56.3%,
            rgba(220,190,120,0.06) 56.3%, rgba(220,190,120,0.06) 56.7%,
            transparent 56.7%),
        /* cricket ball seam arc — left */
        radial-gradient(ellipse 3px 70% at 32% 50%, rgba(210,80,50,0.10) 0%, transparent 100%),
        /* cricket ball seam arc — right */
        radial-gradient(ellipse 3px 70% at 68% 50%, rgba(210,80,50,0.10) 0%, transparent 100%),
        /* top vignette */
        linear-gradient(180deg, rgba(0,0,0,0.45) 0%, transparent 18%),
        /* bottom vignette */
        linear-gradient(0deg,   rgba(0,0,0,0.45) 0%, transparent 18%);
    pointer-events: none;
    z-index: 0;
}
